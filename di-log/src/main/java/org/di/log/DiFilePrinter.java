 ...
 */
public class DiFilePrinter implements DiLogPrinter {
    ...
    private static DiFilePrinter instance;
     ...
     */
    public static synchronized DiFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new DiFilePrinter(logPath, retentionTime);
        }
        return instance;
    }

    public DiFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull DiLogConfig logConfig, int level, String tag, @NonNull String printStr) {
        ...
        worker.put(new DiLogMo(timeMillis, level, tag, printStr));
    }

    private void doPrint(DiLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<DiLogMo> logs = new LinkedBlockingQueue<>();
